...
async function main() {
    ...
    const products = [
        ...
        },
        {
            ...
            description: 'The ultimate introduction to CN Fragrances. This exclusive collector\'s set features 5ml testers of all our signature scents: CN-MUSK, CN-SIGNATURE, LEGENDARY, Bloom Bella, and AGRANO LEATHER. Find your signature essence or gift the art of atmosphere.',
            originalPrice: 3000,
            discountPrice: 2500,
            category: 'Discovery',
            imageUrl: '/discovery-set.jpeg',
            stock: 50,
            isFeatured: true,
        },
    ]
